...
export default function generateShape(r1, r2, r3, r4) {
...

  {
    ...
    { // 1. The biggest circle
      ...
      path.arc(Ox, Oy, R * STEP, rad(180) - angleTop, rad(180) + angleBot, true);

      { // 45deg lines at the bottom
        path.line([Ox, Oy + r1 * STEP], circlePoint(Ox, Oy, R * STEP, -angleBot));
        path.line([Ox, Oy + r1 * STEP], circlePoint(Ox, Oy, R * STEP, rad(180) + angleBot));
      }
    }
  ...
  { // 3. Two circles with lines
    ...
    path.line(circlePoint(Ox, yT, r, rad(180)), circlePoint(Ox, yB, r, rad(180)));
  }
