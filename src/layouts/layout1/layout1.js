...

{
  ...
  // region rotate
  const { container: cAngle, input: iAngle, label: lAngle } = createInputElement("angle");
  const { container: cRotX, input: iRotX, label: lRotX } = createInputElement("rotX");
  const { container: cRotY, input: iRotY, label: lRotY } = createInputElement("rotY");
  ...
  // region scale
  const { container: cScale, input: iScale, label: lScale } = createInputElement("scale");
